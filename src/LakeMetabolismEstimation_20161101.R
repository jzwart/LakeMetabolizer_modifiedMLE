...
source('/Users/jzwart/Documents/Jake/MyPapers/GLEON Catchment & Lake Metabolism/R Code/fillHoles.R')
source('/Users/jzwart/Documents/Jake/MyPapers/GLEON Catchment & Lake Metabolism/R Code/floorMins.R')
# library(xts) # useful for timeseries visulization 
Sys.setenv(tz='GMT')

dir<-'/Users/jzwart/Documents/Jake/MyPapers/GLEON Catchment & Lake Metabolism/data qa_qc/' # directory where data is stored 
lakes<-list.files(dir)
lake<-lakes[i] # current lake for metabolism estimates 
metaData<-read.csv('/Users/jzwart/Documents/Jake/MyPapers/GLEON Catchment & Lake Metabolism/data qa_qc/metadataLookUp.csv',stringsAsFactor=F)
...
# plotting daily fits 
pdf(file.path('/Users/jzwart/Documents/Jake/MyPapers/GLEON Catchment & Lake Metabolism/metab results/20161107/',lake,paste(lake,'dailyFits.pdf',sep='_')),
    width=11,height=8.5)
...
pdf(file.path('/Users/jzwart/Documents/Jake/MyPapers/GLEON Catchment & Lake Metabolism/metab results/20161107/',lake,paste(lake,'metabPlots.pdf',sep='_')),
    width=12,height=14)
par(mfrow=c(2,1))
...
write.table(metab.out,
            file.path('/Users/jzwart/Documents/Jake/MyPapers/GLEON Catchment & Lake Metabolism/metab results/20161107/',lake,paste(lake,'metabEst.txt',sep='_')),
